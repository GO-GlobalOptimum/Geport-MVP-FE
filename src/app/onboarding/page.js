    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <sapn style={{fontWeight: "bold", fontSize: "1.0rem", color: "#FFFFFF"}}>“블로그로 시작하는 나만의 퍼스널 브랜딩, Geport”</sapn><br/><br/>
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                Geport는 사용자가 자신의 경험, 가치, 꿈을 중심으로 자신만의 이야기를 전달할 수 있게 도와줍니다. 마치 개인의 대변인처럼, Geport는 'Soft Skill'을 강조하여 개성과 퍼스널 브랜드를 구축하는 데 초점을 맞춥니다. 사용자는 Geport를 통해 자신의 진정성과 매력을 강조하며, 다른 이들에게 긍정적인 인상을 남길 수 있습니다.<br/>
            </div>
            <div style={{
                alignItems: "center",
                justifyContent: "center",
                ...
                iGeport는 사용자의 블로그 게시물을 분석하여 내면의 감정, 성격 유형, 심리적 상태를 심도 있게 조명합니다. 심리학적 분석과 유사한 방식으로, iGeport는 자기 인식을 증진시키고, 자신의 강점과 개선점에 대한 통찰력을 제공합니다. 이를 통해 사용자는 자신의 내면을 더 깊이 이해하고, 개인적 성장을 이룰 수 있습니다.
            </div>
        </div>
    )
}
